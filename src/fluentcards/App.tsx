  ...
  return (
    <ThemeProvider>
      <div className="h-[100dvh] w-full bg-cream dark:bg-sumi-800 text-ink-700 dark:text-sumi-100 font-sans overflow-hidden relative overscroll-none flex flex-col transition-colors duration-200">
        ...
        <div className="absolute top-0 right-10 w-40 h-40 bg-cinnabar-50/30 dark:bg-cinnabar-800/20 rounded-full mix-blend-multiply dark:mix-blend-lighten filter blur-2xl opacity-70 animate-pulse" style={{ animationDelay: '2s' }}></div>
        <div className="absolute -bottom-8 left-20 w-40 h-40 bg-cinnabar-200/20 dark:bg-cinnabar-900/20 rounded-full mix-blend-multiply dark:mix-blend-lighten filter blur-2xl opacity-70 animate-pulse" style={{ animationDelay: '4s' }}></div>
